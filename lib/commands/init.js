...
import { detectStack, describeStack, frameworkSkillsFor, detectToolchain } from '../detect.js';
...
function printDone({ paths, detection, minimal, noMcps, noHooks }) {
  ...
  console.log(pc.dim('  3.'), 'Try:', pc.cyan('/brainstorm') + ',', pc.cyan('/implement') + ',', pc.cyan('/debug') + ', or', pc.cyan('/mcp-help'));
  if (!minimal) {
